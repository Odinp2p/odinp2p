...
async function submitBtn(inputId,inputId2='', resultMsg, errorMsg,functionName,transactionLink="",writeCall=false) {
    ...
    if (validateAndTab(inputId, errorMsg)) {
        ...
        try {
			...
			if(_inputId2===undefined){
				...
				result =  await contract.methods[functionName](_inputId,_inputId2).call();
...
async function noParams(functionName, paraId,transactionLink="",writeCall=false) {
    ...
    try {
        ...
        var totalLinkIDResult = await contract.methods[functionName]().call({ from: totalLinkIDAccount });
...
/*------------------------------------------------Read Page Start ------------------------------------------- */
    ...
    $("#activeLevelsViewSubmit").click(async function(event){
	  ...
	  submitBtn('activeLevelsViewInput', undefined ,'activeLevelsViewPara', 'activeLevelsViewErrorMessage', 'activeLevelsView');
    });
    ...
    $("#activeUserSubmit").click(function(event){
      event.preventDefault();
      submitBtn('activeUserInput',undefined, 'activeUserPara', 'activeUserErrorMessage', 'activeUser');
    });
    // activeUser end
    ...
    $("#bonusInfosSubmit").click(function(event){
      event.preventDefault();
      submitBtn('bonusInfosInput', undefined,'bonusInfosPara', 'bonusInfosErrorMessage', 'bonusInfos');
    });
    // bonusInfos end
    ...
    $("#directUserSubmit").click(function(event){
      event.preventDefault();
      submitBtn('directUserInput',undefined, 'directUserPara', 'directUserErrorMessage', 'directUser');
    });
    // directUser end
    ...
    $("#findGenUserSubmit").click(function(event){
      event.preventDefault();
      submitBtn('findGenUserInput',undefined, 'findGenUserPara', 'findGenUserErrorMessage', 'findGenUser');
	//   console.log(findGen);
    });
    // findGefindGenUser
    ...
    $("#findOrderSubmit").click(function(event){
      event.preventDefault();
      submitBtn('findOrderInput',undefined, 'findOrderPara', 'findOrderErrorMessage', 'findOrder');
    ...
    $("#getPriceSubmit").click(async function(event){
      event.preventDefault();
      submitBtn('getPriceInput',undefined, 'getPricePara', 'getPriceErrorMessage', 'getPrice');
    });
    // getPrice end
  ...
  $("#ghAddressSubmit").click(function(event){
    event.preventDefault();
    submitBtn('ghAddressInput',undefined, 'ghAddressPara', 'ghAddressErrorMessage', 'ghAddress');
  ...
  $("#ghInfosSubmit").click(function(event){
    event.preventDefault();
    submitBtn('ghInfosInput',undefined, 'ghInfosPara', 'ghInfosErrorMessage', 'ghInfos');
  });
  // ghInfos end
  ...
  $("#ghPotentialSubmit").click(function(event){
    event.preventDefault();
    submitBtn('ghPotentialInput',undefined, 'ghPotentialPara', 'ghPotentialErrorMessage', 'ghPotential');
  ...
  $("#linkExpireTimeSubmit").click(function(event){
    event.preventDefault();
    submitBtn('linkExpireTimeInput',undefined, 'linkExpireTimePara', 'linkExpireTimeErrorMessage', 'linkExpireTime');
  });
  // linkExpireTime end
  ...
  $("#linkInfosSubmit").click(function(event){
    event.preventDefault();
    submitBtn('linkInfosInput',undefined, 'linkInfosPara', 'linkInfosErrorMessage', 'linkInfos');
  });
  // linkInfos end
  ...
  $("#matureOrderSubmit").click(function(event){
    event.preventDefault();
    submitBtn('matureOrderInput1','matureOrderInput2', 'matureOrderPara', 'matureOrderErrorMessage', 'matureOrder');
  });
  // matureOrder end
  ...
  $("#payPhValueSubmit").click(function(event){
    event.preventDefault();
	submitBtn('payPhValueInput1','payPhValueInput2', 'payPhValuePara', 'payPhValueErrorMessage', 'payPhValue');
  ...
  $("#phAddressSubmit").click(function(event){
    event.preventDefault();
    submitBtn('phAddressInput',undefined, 'phAddressPara', 'phAddressErrorMessage', 'phAddress');
  });
  // phAddress end
  ...
  $("#phGrowthSubmit").click(function(event){
    event.preventDefault();
    submitBtn('phGrowthInput',undefined, 'phGrowthPara', 'phGrowthErrorMessage', 'phGrowth');
  ...
  $("#phInfosSubmit").click(function(event){
    event.preventDefault();
    submitBtn('phInfosInput',undefined, 'phInfosPara', 'phInfosErrorMessage', 'phInfos');
  });
  // phInfos end
  ...
  $("#royaltysSubmit").click(function(event){
	event.preventDefault();
    submitBtn('royaltysInput',undefined, 'royaltysPara', 'royaltysErrorMessage', 'royaltys');
  });
  // royaltys end
  ...
  $("#totalDirectSubmit").click(function(event){
    event.preventDefault();
    submitBtn('totalDirectInput',undefined, 'totalDirectPara', 'totalDirectErrorMessage', 'totalDirect');
  });
  // totalDirect end
  ...
  $("#totalGainsSubmit").click(function(event){
    event.preventDefault();
    submitBtn('totalGainsInput',undefined, 'totalGainsPara', 'totalGainsErrorMessage', 'totalGains');
  });
  // totalGains end
  ...
  $("#userInfosSubmit").click(function(event){
    event.preventDefault();
    submitBtn('userInfosInput',undefined, 'userInfosPara', 'userInfosErrorMessage', 'userInfos');
  });
  // userInfos end
  ...
  $("#userLiveStatusSubmit").click(function(event){
    event.preventDefault();
    submitBtn('userLiveStatusInput',undefined, 'userLiveStatusPara', 'userLiveStatusErrorMessage', 'userLiveStatus');
  ...
  $("#userPhViewSubmit").click(function(event){
    event.preventDefault();
    submitBtn('userPhViewInput',undefined, 'userPhViewPara', 'userPhViewErrorMessage', 'UserPhView');
  });
  // userPhView end
  ...
  $("#userRoyaltySubmit").click(function(event){
    event.preventDefault();
    submitBtn('userRoyaltyInput',undefined, 'userRoyaltyPara', 'userRoyaltyErrorMessage', 'userRoyalty');
  });
  // userRoyalty end
  ...
  $("#viewLinkSubmit").click(function(event){
    event.preventDefault();
    submitBtn('viewLinkInput',undefined, 'userRoyaltyPara', 'userRoyaltyErrorMessage', 'userRoyalty');
  });
  // viewLink end
...
$("#cancelLinkSubmit").click(function(event){
    event.preventDefault();
	submitBtn('cancelLinkInput',undefined, 'cancelLinkPara', 'cancelLinkErrorMessage', 'cancelLink','hash_1',true);
  ...
  $("#makeGhSubmit").click(function(event){
    event.preventDefault();
	submitBtn('makeGhInput',undefined, 'makeGhPara', 'makeGhErrorMessage', 'makeGh','hash_4',true);
  ...
  $("#makePhSubmit").click(function(event){
    event.preventDefault();
	submitBtn('makePhInput',undefined, 'makePhPara', 'makePhErrorMessage', 'makePh','hash_5',true);
  ...
  $("#payLinkSubmit").click(function(event){
    event.preventDefault();
	submitBtn('payLinkInput',undefined, 'payLinkPara', 'payLinkErrorMessage', 'payLink','hash_6',true);
  ...
  $("#regUserSubmit").click(function(event){
    event.preventDefault();
	submitBtn('regUserInput',undefined, 'regUserPara', 'regUserErrorMessage', 'regUser','hash_7',true);
  ...
  $("#remainMatchingSubmit").click(function(event){
    event.preventDefault();
	submitBtn('remainMatchingInput',undefined, 'remainMatchingPara', 'remainMatchingErrorMessage', 'remainMatching','hash_8',true);
